# codes of conduct API


## Get all codes of conduct

<div class="api-method-banner">
  <span class="api-method method-get">GET</span> <span class="api-path">/codes_of_conduct</span>
</div>
...
=== "Python (Requests)"
    ...
    response = requests.get('https://api.github.com/codes_of_conduct', headers=headers)
    print(response.json())
    ```
...
<div class="api-method-banner">
  <span class="api-method method-get">GET</span> <span class="api-path">/codes_of_conduct/{key}</span>
</div>
...
| --- | --- | --- | --- | --- |
| `{key}` | `string` | Yes | (Required) key parameter | `<string>` |
...
=== "Python (Requests)"
    ...
    response = requests.get('https://api.github.com/codes_of_conduct/{key}', headers=headers)
    print(response.json())
    ```
